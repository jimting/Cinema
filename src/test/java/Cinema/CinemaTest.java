...
public class CinemaTest {
	...
	//測試購買新電影
	@Test	
	public void testOrderNewMovie() throws InterruptedException 
	{	
	...
	//測試看看是否有拿到新訊息
	@Test
	public void testIndexGetNewNotification()
	{
		driver.get("http://140.121.196.23:4107/");
		//等個幾秒 讓頁面Ajax loading好
		waitForPageLoaded();
	...
	//測試購買新周邊
	@Test	
	public void testOrderNewGrocery() throws InterruptedException 
	{	
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		driver.get("http://140.121.196.23:4107/shop.html");
		//等個幾秒 讓頁面Ajax loading好
